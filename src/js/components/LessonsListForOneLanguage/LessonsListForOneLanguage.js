...
import './LessonsListForOneLanguage.scss';
...
const LessonsListForOneLanguageComponent = ( props ) => {
    ...
    return (
        ...
        <div className = { `lessonsListForOneLanguage` } data-language = { language } >
            <div
...
export function LessonsListForOneLanguage( props ){

    // const language = useSelector( languageSlice );
    // const dispatch = useDispatch();

    return (
        <LessonsListForOneLanguageComponent
            { ...props }
